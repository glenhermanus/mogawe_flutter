...
class FactCheckIn extends StatefulWidget {
  const FactCheckIn({
    required this.fact,
  ...
  @override
  _FactCheckInState createState() => _FactCheckInState();
}

class _FactCheckInState extends State<FactCheckIn> {
  String _address = "";
