...
class StandardFactWidgetGenerator extends StatefulWidget {
  const StandardFactWidgetGenerator(
  ...
  @override
  _StandardFactWidgetGeneratorState createState() => _StandardFactWidgetGeneratorState();
}

class _StandardFactWidgetGeneratorState extends State<StandardFactWidgetGenerator> {
