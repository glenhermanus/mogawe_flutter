...
class CardReceived extends StatelessWidget {
  ...
  CardReceived({this.pesan, this.userProfileResponse, this.chatResponse});

  @override
  Widget build(BuildContext context) {
    String? time2;
    print(this.pesan);
    String date = DateFormat.yMMMMEEEEd("id").format(this.pesan?.results.comments.last.timestamp);
