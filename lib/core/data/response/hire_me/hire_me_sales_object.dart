class HireMeSalesResponsesObject{
  ...
  factory HireMeSalesResponsesObject.fromJson(Map<String, dynamic> json){
    return HireMeSalesResponsesObject(
      uuidobj: json['uuid'],
